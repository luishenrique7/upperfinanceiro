...
defaultOptions.ui.errorMessages = {
    ...
    wordTwoCharacterClasses: "Use caracteres diferentes",
    wordRepetitions: "Muitas repetições",
    wordSequences: "Sua senha contém sequências"
};
defaultOptions.ui.verdicts = ["Fácil", "Normal", "Média", "Forte", "Muito Forte"];
...
//Função para movimentar os paineis do dashboard up/down
...
$.fn.zabuto_calendar_language = function (lang) {
    ...
    switch (lang.toLowerCase()) {
        case 'en':
            return {
                ...
                dow_labels: ["Seg", "Ter", "Qua", "Qui", "Se", "Sáb", "Dom"]
            };
            break;
    }
   ...
   $(document).ready(function () {
    $("#my-calendar").zabuto_calendar({
      legend: [
        {type: "text", label: "Contas especiais", badge: "00"},
        {type: "block", label: "Contas regulares", classname: "purple"},
        {type: "spacer"},
        {type: "text", label: "Mau"},
